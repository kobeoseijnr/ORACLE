...
class TwoStageAmp(gym.Env):
    ...
    #obtains yaml file
    _METHODOLOGY_DIR = Path(__file__).resolve().parents[2]
    path = str(_METHODOLOGY_DIR)
    CIR_YAML = str(
        _METHODOLOGY_DIR
        / 'eval_engines'
        / 'ngspice'
    ...
    def __init__(self, env_config):
        ...
        if self.generalize == False:
            ...
            load_specs_path = os.path.join(TwoStageAmp.path, "autockt", "gen_specs", "ngspice_specs_gen_two_stage_opamp")
