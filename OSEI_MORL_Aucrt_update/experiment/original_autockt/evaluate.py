...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Run Original AutoCkt evaluation")
    parser.add_argument("checkpoint", type=str, help="Path to trained model checkpoint")
    parser.add_argument("--num_val_specs", type=int, default=1000, help="Number of validation specs (default: 1000)")
    parser.add_argument("--traj_len", type=int, default=60, help="Trajectory length (default: 60)")
    
    args = parser.parse_args()
    
    success = run_evaluation(args.checkpoint, args.num_val_specs, args.traj_len)
