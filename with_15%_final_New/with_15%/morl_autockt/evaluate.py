...
def load_trained_model(model_path):
    ...
    try:
        ...
        scalarization = checkpoint.get('scalarization', 'cosine')
        print(f"Model dimensions: state_dim={state_dim}, action_dim={action_dim}, reward_dim={reward_dim}, scalarization={scalarization}")
        
        agent = MO_DQN_Agent(state_dim=state_dim, action_dim=action_dim, reward_dim=reward_dim, scalarization=scalarization)
